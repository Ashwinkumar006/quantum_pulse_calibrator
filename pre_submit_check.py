...
assert 0.0 < reward < 1.0, f"FAILED: Expected reward strictly between 0 and 1, got {reward}"
print("    PASSED - Reward strictly between 0 and 1!")
...
assert 0.0 < reward2 < 1.0, f"FAILED: Expected reward strictly between 0 and 1, got {reward2}"
print("    PASSED - Reward strictly between 0 and 1!")
...
assert 0.0 < reward3 < 1.0, f"FAILED: Expected reward strictly between 0 and 1, got {reward3}"
print("    PASSED - Reward strictly between 0 and 1!")
